...
//   // Enhanced flag image handling
//   const getFlagImageUrl = () => {
//     if (blog.country_flag) return blog.country_flag;
//     if (blog.country_code) return `https://flagcdn.com/w320/${blog.country_code.toLowerCase()}.png`;
//     return '/default-blog.jpg';
//   };

//   const flagImageUrl = getFlagImageUrl();
...
//           }}
//         >
//           {blog.country_name || 'Travel Destination'}
//         </Typography>
//       </Box>
...
//               <img 
//                 src={flagImageUrl} 
//                 alt={blog.country_name} 
//                 style={{ width: '20px', height: '15px', objectFit: 'cover' }} 
//                 title={blog.country_name}
//               />
//             </Box>
//           )}
//           <Typography variant="caption" sx={{ ml: 'auto', color: 'text.secondary' }}>
...
// After successfully done the deleting function
...
const BlogCard = ({ blog, onDelete }) => {
  ...
  // const userLike = blog.likes?.find(like => like.user_id === user?.id);
